...
#define COMMAND_HANDLER_REGISTER(uid)                                                                                    \
	namespace                                                                                                            \
	{                                                                                                                    \
		struct COMMAND_HANDLER_PASTE_AUX(command_handler_register_helper_, uid) : public command_handler_register_helper \
		{                                                                                                                \
...
namespace Commands
{
	...
	struct command_info
	{
		...
		command_info(std::string name, empty_vector_init<std::string> arguments = empty_vector_init<std::string>(),
			...
			: name(name), arguments(arguments), optional_arguments(optional_arguments), partial_min_chars(partial_min_chars), require_character(false), duty_restrict(false)
		{
		}
	};
